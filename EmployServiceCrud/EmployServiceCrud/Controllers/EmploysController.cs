...
namespace EmployServiceCrud.Controllers
{
    ...
    public class EmploysController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Employ>>> GetEmployees()
        {
            ...
            Console.WriteLine(SendMail.MailInfo("madhusparkle76@gmail.com", "Dotnet Code", "This is My First Mail in Dotnet"));
        ...
        public async Task<ActionResult<Employ>> GetEmploy(int id)
        {
            try
            {
                string smtpUser = "madhusudhanchittibabu@gmail.com"; // Gmail login account
                string appPassword = "hfol wjgf apqn bvhw";      // App password from Google
                string fromAddress = "madhusudhanchittibabu@gmail.com"; // Must be allowed as alias
                string toAddress = "madhuchittibabu@gmail.com";
